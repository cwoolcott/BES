...
// WIZARD  ===============================================================================
jQuery(function($) {
				// Basic wizard with checkerrorvalidation
				$("#survey_container").wizard({
						...
						beforeSelect: function( event, state ) {
							...
							console.log('STEP:');
							console.log($(this).wizard('state').step);
					...
					errorPlacement: function(error, element) {
						...
						console.log(error[0].htmlFor);

						errorname="input[name='"+ error[0].htmlFor + "']";

						$('html, body').animate({
							scrollTop: $(errorname).offset().top - 200
							}, 500);
					}
			    });
				//  progress bar
